...
_lr_productions = [
  ...
  ('S -> ADVP PUNCTUATION ADVP PUNCTUATION','S',4,'p_S','lex.py',186),
  ('S -> VP CP PUNCTUATION','S',3,'p_S','lex.py',187),
  ('S -> ADVP LPAREN INTERJECTIONS NP RPAREN PUNCTUATION','S',6,'p_S','lex.py',188),
  ('S -> ADVP LPAREN VP RPAREN PUNCTUATION','S',5,'p_S','lex.py',189),
  ('S -> ADVP PUNCTUATION','S',2,'p_S','lex.py',190),
  ('S -> VP LPAREN PP RPAREN PUNCTUATION','S',5,'p_S','lex.py',191),
  ('S -> CP LPAREN CP RPAREN PUNCTUATION','S',5,'p_S','lex.py',192),
  ('S -> VP VP ADJP LPAREN ADVP RPAREN PUNCTUATION','S',7,'p_S','lex.py',193),
  ('S -> ADVP VP PP LPAREN ADVP RPAREN PUNCTUATION','S',7,'p_S','lex.py',194),
  ('S -> VP NP PP PUNCTUATION','S',4,'p_S','lex.py',195),
  ('S -> VP ADVP ADJP PUNCTUATION','S',4,'p_S','lex.py',196),
  ('S -> VP LPAREN VP PP RPAREN PUNCTUATION','S',6,'p_S','lex.py',197),
  ('S -> VP PP ADJP PUNCTUATION','S',4,'p_S','lex.py',198),
  ('S -> CP VP NP PUNCTUATION','S',4,'p_S','lex.py',199),
  ('S -> VP VP PUNCTUATION','S',3,'p_S','lex.py',200),
  ('S -> ADVP PP PUNCTUATION','S',3,'p_S','lex.py',201),
  ('S -> ADVP LPAREN INTERJECTIONS RPAREN PUNCTUATION','S',5,'p_S','lex.py',202),
  ('S -> VP LPAREN VP RPAREN PUNCTUATION','S',5,'p_S','lex.py',203),
  ('S -> ADVP LPAREN INTERJECTIONS NOUNS RPAREN PUNCTUATION','S',6,'p_S','lex.py',204),
  ('S -> VP VP VP ADJP LPAREN ADVP RPAREN PUNCTUATION','S',8,'p_S','lex.py',205),
  ('S -> VP CP LPAREN CONJUNCTIONS VP RPAREN PUNCTUATION','S',7,'p_S','lex.py',206),
  ('S -> VP LPAREN VERBS VERBS PP RPAREN PUNCTUATION','S',7,'p_S','lex.py',207),
  ('S -> VP LPAREN PP RPAREN','S',4,'p_S','lex.py',208),
  ('ADVP -> ADVERBS NOUNS','ADVP',2,'p_ADVP','lex.py',216),
  ('ADVP -> ADVERBS VERBS','ADVP',2,'p_ADVP','lex.py',217),
  ('ADVP -> ADVERBS VERBS ADJP','ADVP',3,'p_ADVP','lex.py',218),
  ('ADVP -> ADVERBS VERBS ADVERBS','ADVP',3,'p_ADVP','lex.py',219),
  ('ADVP -> ADVERBS VERBS ADVERBS NOUNS','ADVP',4,'p_ADVP','lex.py',220),
  ('ADVP -> ADVERBS PP','ADVP',2,'p_ADVP','lex.py',221),
  ('ADVP -> ADVERBS VERBS DETERMINANT VERBS NOUNS','ADVP',5,'p_ADVP','lex.py',222),
  ('VP -> VERBS VERBS ADVERBS','VP',3,'p_VP','lex.py',230),
  ('VP -> VERBS ADVERBS','VP',2,'p_VP','lex.py',231),
  ('VP -> PRONOUNS VERBS PRONOUNS','VP',3,'p_VP','lex.py',232),
  ('VP -> PRONOUNS VERBS','VP',2,'p_VP','lex.py',233),
  ('VP -> PRONOUNS VERBS VERBS ADVERBS','VP',4,'p_VP','lex.py',234),
  ('VP -> VERBS PRONOUNS ADVERBS','VP',3,'p_VP','lex.py',235),
  ('VP -> VERBS ADVERBS VERBS','VP',3,'p_VP','lex.py',236),
  ('VP -> PRONOUNS VERBS VERBS ADVERBS NOUNS','VP',5,'p_VP','lex.py',237),
  ('VP -> VERBS ADJECTIVES NOUNS','VP',3,'p_VP','lex.py',238),
  ('VP -> ARTICLES NOUNS VERBS ADVERBS VERBS VERBS DETERMINANT','VP',7,'p_VP','lex.py',239),
  ('VP -> VERBS NOUNS PP','VP',3,'p_VP','lex.py',240),
  ('VP -> VERBS ADJECTIVES','VP',2,'p_VP','lex.py',241),
  ('VP -> VERBS PRONOUNS NOUNS ARTICLES VERBS','VP',5,'p_VP','lex.py',242),
  ('NP -> NOUNS PREPOSITIONS ADJECTIVES','NP',3,'p_NP','lex.py',249),
  ('NP -> PRONOUNS NOUNS','NP',2,'p_NP','lex.py',250),
  ('NP -> ARTICLES NOUNS','NP',2,'p_NP','lex.py',251),
  ('NP -> DETERMINANT NOUNS','NP',2,'p_NP','lex.py',252),
  ('PP -> PREPOSITIONS NP VP','PP',3,'p_PP','lex.py',259),
  ('PP -> PREPOSITIONS VERBS','PP',2,'p_PP','lex.py',260),
  ('PP -> PREPOSITIONS ADJP','PP',2,'p_PP','lex.py',261),
  ('PP -> PREPOSITIONS NP','PP',2,'p_PP','lex.py',262),
  ('PP -> PREPOSITIONS NOUNS','PP',2,'p_PP','lex.py',263),
  ('PP -> PREPOSITIONS PRONOUNS PRONOUNS NOUNS','PP',4,'p_PP','lex.py',264),
  ('PP -> PREPOSITIONS ARTICLES NOUNS PREPOSITIONS NOUNS DETERMINANT','PP',6,'p_PP','lex.py',265),
  ('PP -> PREPOSITIONS ARTICLES NOUNS','PP',3,'p_PP','lex.py',266),
  ('PP -> PREPOSITIONS NP ARTICLES VERBS','PP',4,'p_PP','lex.py',267),
  ('CP -> CONJUNCTIONS VP','CP',2,'p_CP','lex.py',274),
  ('CP -> CONJUNCTIONS CONJUNCTIONS','CP',2,'p_CP','lex.py',275),
  ('ADJP -> DETERMINANT ADJECTIVES NOUNS','ADJP',3,'p_ADJP','lex.py',282),
  ('ADJP -> ARTICLES ADJECTIVES NOUNS','ADJP',3,'p_ADJP','lex.py',283),
  ('ADJP -> DETERMINANT ADJECTIVES','ADJP',2,'p_ADJP','lex.py',284),
  ('ADJP -> PRONOUNS ADJECTIVES NOUNS','ADJP',3,'p_ADJP','lex.py',285),
  ('ADJP -> NOUNS ADJECTIVES','ADJP',2,'p_ADJP','lex.py',286),
]
